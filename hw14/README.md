# Risk: Conquer the World with Graphs

You will implement several graph algorithms to develop a tool for the game of Risk.

**Grading:**
This homework will take the place of your final.
Therefore it will be worth 30 points instead of the usual 10.

**Due date:**
Friday, 15 May at midnight (last day of finals week)
...
1. If you play a game of risk with other students from the class (using https://warzone.com or any other resource) then you will get 1 pt of extra credit on the assignment.

## Submission

Submit the link to your github repo into sakai.

If you played the extra credit game of risk,
state who you played it with in the sakai entry.
